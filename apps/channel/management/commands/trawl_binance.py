...
def _pull_binance_data():
    try:
        ...
        req = get('https://binance.com/public?command=returnTicker')
...
def _compute_and_save_indicators(resample_period_par):
    ...
    for transaction_currency, counter_currency in pairs_to_iterate:
        ...
        last_time_computed = get_first_resampled_time(BINANCE, transaction_currency, counter_currency, resample_period)
