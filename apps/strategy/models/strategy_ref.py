...
# A datastructure to keep all possible strategies in the system
...
# get all class names
# TODO: get it from ALL_STRATEGIES by copy it in a new object, then loop over ALL_STRATEGIES.popitem()
