...
def _main(queue_prefixes, custom_dispatch_func, concurrency=5, logging_level="WARN", region='us-east-1', access_key_id=None, secret_access_key=None):
    ...
    manager = ManagerWorker(queue_prefixes, concurrency, custom_dispatch_func=custom_dispatch_func, region=region, access_key_id=access_key_id, secret_access_key=secret_access_key)
    manager.start()
    manager.sleep()
